...
export const SVGLogo: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
    ...
    return (
        <svg width={"20em"} ref={svgRef} {...props} version="1.1" className="subtitle" xmlns="http://www.w3.org/2000/svg"
            xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 229.2 69.6" enableBackground="new 0 0 229.2 69.6"
            xmlSpace="preserve">
            <defs>
            ...
            <path className="path" clip-path="url(#websiteClip)"
            ...
            <path className="path" clip-path="url(#websiteClip)" d="M171,9.13s-11.33,10.38-8,11.92,43-2.8,43-2.8" fill="none"
